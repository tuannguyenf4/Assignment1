...
namespace api.Repositories
{
    public interface IClientRepository
    {
        ...
        Task<Client[]> SearchClients(string searchTerm);
    }
    ...
    public class ClientRepository : IClientRepository
    {
        ...
        public async Task<Client[]> SearchClients(string searchTerm)
        {
            // Search the client repository by first or last name
            return await dataContext.Clients.Where(x => x.FirstName.Contains(searchTerm) || x.LastName.Contains(searchTerm)).ToArrayAsync();
        }
    }
}
